...
public final class PromptTemplateStore: @unchecked Sendable {
    ...
    public static func defaultTemplate(for key: PromptTemplateKey) -> String {
        ...
        case .actionBlockDocs:
            ...
            - [ACTION: EDIT_DOCUMENT_SECTION] documentId: <uuid> section: <header text without # prefix> <<<CONTENT <replacement section> CONTENT [/ACTION]
            ...
            - [ACTION: CREATE_MILESTONE] phaseId: <uuid-or-placeholder> name: <text> deadline: <YYYY-MM-DD> [/ACTION]
            - [ACTION: CREATE_TASK] milestoneId: <uuid-or-placeholder> name: <text> priority: <low|normal|high> effortType: <quickWin|deepFocus|admin|creative|physical> deadline: <YYYY-MM-DD> [/ACTION]
            ...
            - [ACTION: UPDATE_PROJECT] projectId: <uuid> name: <text> lifecycleState: <state> definitionOfDone: <text> notes: <text> [/ACTION]
            - [ACTION: UPDATE_PHASE] phaseId: <uuid> name: <text> status: <notStarted|inProgress|completed> definitionOfDone: <text> [/ACTION]
            - [ACTION: UPDATE_MILESTONE] milestoneId: <uuid> name: <text> phaseId: <uuid> deadline: <YYYY-MM-DD> priority: <low|normal|high> definitionOfDone: <text> notes: <text> [/ACTION]
            - [ACTION: UPDATE_TASK] taskId: <uuid> name: <text> milestoneId: <uuid> deadline: <YYYY-MM-DD> priority: <low|normal|high> effortType: <type> definitionOfDone: <text> notes: <text> [/ACTION]
            - [ACTION: UPDATE_SUBTASK] subtaskId: <uuid> name: <text> definitionOfDone: <text> [/ACTION]
            Use 'none' as the value to clear an optional field.
